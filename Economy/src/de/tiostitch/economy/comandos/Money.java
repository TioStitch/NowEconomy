...
public class Money implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String s, String[] args) {
        if (sender.hasPermission("Economy.Manager")) {
            if (!(sender instanceof Player)) {
                sender.sendMessage("§cApenas jogadores podem executar isto!");
                return false;
            }

                if (args.length == 0) {
                    Player player = (Player) sender;
                    long coins = (long) EcoManager.getCoins(player.getName(), player.getUniqueId().toString());
                ...
                if (args.length == 1) {
                    ...
                    if (target != null) {
                        long coins = (long) EcoManager.getCoins(target.getName(), target.getUniqueId().toString());
                ...
                if (enviarList.contains(input)) {
                    if (sender.hasPermission("Economy.Enviar")) {
                        ...
                        try {
                            ...
                            long senderCoins = (long) EcoManager.getCoins(sender.getName(), player.getName());
    ...
    public String getTagTop(String player) {
        ...
        } else if (Objects.equals(EcoManager.topThird, player)) {
